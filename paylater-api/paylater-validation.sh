...
curl -i -X POST 'http://52.77.22.148:3001/users/v1/paynow' -H "access-token:tk_jghephjr" -H "source:ANDROID" -d "customer_key=c_jgq53x5k&order_id=jhitjaoh&shipment_id=jhitjaoh&wallet_amount=0&payble_amount=234.5&source=ANDROID&order_type=wallet&txt_id=txt-id-001" || no source in header
